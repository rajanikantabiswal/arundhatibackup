<?php
    if(isset($_POST['submit'])){
        ...
        $sub   = $_POST['subject'];
        $msg  = $_POST['message'];
        $to = "singhswagatika23@gmail.com , pranatipriyambadamohanty@gmail.com";
        $subject = "Career Form From AJPL";
...
?>
                ...
                <div class="contact-form">
                    <form id="ttm-contactform" class="ttm-contactform wrap-form clearfix" method="post" action="" enctype="multipart/form-data">
                                <input type="hidden">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <label>
