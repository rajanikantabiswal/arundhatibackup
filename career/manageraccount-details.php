          ...
          <div class="wd-job-author2">
            <div class="content-left">
              ...
              <div class="content">
                ...
                <h6><a href="#">Manager Accounts<span class="icon-bolt"></span></a></h6>
                <ul class="job-info">
          ...
          <article class="job-article tf-tab single-job">
            ...
            <div class="content-tab">
              <div class="inner-content">
                ...
                <p>Job Overview: The General Manager Accountsis responsible for managing financial transactions, preparing financial reports and ensuring the accuracy of financial records. They also assist in budget preparation and analysis, and perform day-to-day accounting functions.</p>
                <ul class="list-dot">
                  <li>Record and process financial transactions such as accounts payable, accounts receivable, payroll, and general ledger entries.</li>
                  <li> Maintain accurate and up-to-date financial records and documentation.</li>
                  <li> Prepare and analyze financial reports, including balance sheets, income statements, and cash flow statements.	</li>
                  <li> Ensure compliance with accounting policies, procedures, and regulations.</li>
                  <li> Communicate with internal and external stakeholders to resolve financial issues and answer inquiries.</li>
                  <li> Reconcile bank statement.</li>
                  <li> Perform month-end and year-end closing activities like TDS filing/ GST filing and reconciliation. </li>
                  <li> Assist with audits and financial statement preparation.</li>
                  <li> Provide support to other accounting and finance functions as needed.</li>
                </ul>
                <h6>QUALIFICATION :</h6>
        ...
        <div class="col-lg-4">
          ...
          <h6>Contact Details</h6>
            <ul class="list-infor">
              ...
              <li><div class="category">Address</div><div class="detail">Plot No – 86/B, Goutam Nagar, Bhubaneswar, Odisha</div></li>
