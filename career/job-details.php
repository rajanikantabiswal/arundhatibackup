          ...
          <div class="wd-job-author2">
            <div class="content-left">
              ...
              <div class="content">
                ...
                <h6><a href="#">HR Executive <span class="icon-bolt"></span></a></h6>
                <ul class="job-info">
          ...
          <article class="job-article tf-tab single-job">
            ...
            <div class="content-tab">
              <div class="inner-content">
                ...
                <ul class="list-dot">
                  <li> Design compensation and benefits packages.</li>
                  <li> Implement performance review procedures (e.g. quarterly/annual and 360° evaluations).</li>
                  <li> Develop fair HR policies and ensure employees understand and comply with them.</li>
                  <li> Implement effective sourcing, screening and interviewing techniques.</li>
                  <li> Act as the point of contact regarding labor legislation issues.</li>
                  <li> Manage employees’ grievances.</li>
                  <li> Measure employee retention and turnover rates.</li>
                  <li> Oversee daily operations of the HR department.</li>
                  <li> Hand on payroll system work. </li>
                </ul>
                <h6>QUALIFICATION :</h6>
                <ul class="list-dot mg-bt-15">
                  <li>Bachelor degree or master degree in HR, business administration.</li>
                  <li>Need to have basic understanding of Computer, Microsoft Word, Excel.</li>
                  <li>Work Experience preferred (if any)</li>
                </ul>
                <h6>REQUIREMENTS:</h6>
                <ul class="list-dot mg-bt-15">
                  <li>Proven work experience as an HR Executive or similar role.</li>
                  <li>Familiarity with Human Resources Management Systems and Applicant Tracking Systems.</li>
                  <li>Experience with full-cycle recruiting.</li>
                  <li>Good knowledge of labor legislation (particularly employment contracts, employee leaves and insurance).</li>
