          ...
          <div class="wd-job-author2">
            <div class="content-left">
              ...
              <div class="content">
                ...
                <h6><a href="#">DGM (Franchise Business Development)<span class="icon-bolt"></span></a></h6>
                <ul class="job-info">
          ...
          <article class="job-article tf-tab single-job">
            ...
            <div class="content-tab">
              <div class="inner-content">
                ...
                <ul class="list-dot">
                  <li> Identifying target markets and exploring possibilities of joining hands with prospective Franchisee seekers / Franchisee partners.</li>
                  <li> Negotiating financial terms and formalizing franchisee contracts / agreements / bonds.</li>
                  <li> Working with cross functional teams to set up Franchise Outlets and device road map for key deliverables i, e expansion of franchise business (FOCO and FOFO Module) partners through Pan India Level.</li>
                  <li> Defining targets, Budgeting and Business Plans to ensure healthy ROI as discussed and agreed with Franchisee Partner.</li>
                  <li> Conducting exhibitions for brand awareness and franchisee promotions.</li>
                  <li> Successfully launching a Business Model leveraging the previous loopholes and building a better operational workflow which brought in revenue.</li>
                  <li> Proficient in identifying investors with credentials.</li>
                  <li> Engaged in analyzing the market as per brand sustainability and identifying the investors for taking franchise; negotiating with investors with ROI and coming to a suitable deal.</li>
                  <li> Guiding franchisees for Identifying the prospective areas and undertaking feasibility studies to set-up franchise outlets, negotiating and setting up the same including exclusive counters.</li>
                  <li> Identifying and developing new streams for long term revenue growth and maintaining relationships with customers to achieve repeat / referral business.</li>
                  <li>Giving presentations on the Franchisee module, market position, brand and various related matters to investors with ROI.</li>
                  <li>Developing training programs for the franchisee executives (Support Function staff) and channel partners.</li>
                  <li> Driving promotional strategies that ensure financial success for the business; maintaining cordial relationship with franchisee and leading team for franchisee development for the delegated region.</li>
                </ul>
                <h6>QUALIFICATION :</h6>
                <ul class="list-dot mg-bt-15">
                  <li>MBA-Specialization of Business Management.</li>
                  <li>Minimum 10th Years’ Experience In Same Field.</li>
                </ul>
