          ...
          <div class="wd-job-author2">
            <div class="content-left">
              ...
              <div class="content">
                ...
                <h6><a href="#">Media Marketing<span class="icon-bolt"></span></a></h6>
                <ul class="job-info">
          ...
          <article class="job-article tf-tab single-job">
            ...
            <div class="content-tab">
              <div class="inner-content">
                ...
                <ul class="list-dot">
                  <li> Corporate Branding and Communication.</li>
                  <li> Media Management.	</li>
                  <li> Media Planning, Media Negotiation & Media rapport building	</li>
                  <li> ATL/BTL & Events.</li>
                  <li> Client Servicing.</li>
                  <li> Corporate Affairs & Government liaison.</li>
                  <li> Conduct press conferences and briefings. </li>
                  <li> Scan the media marketplace to keep up-to-date on the latest media trends.</li>
                  <li> Negotiate with media channels to close competitive deals.</li>
                  <li> <b>Schedule correctness & schedule tracking for both FCT consumption & budget consumption as per deal.</b></li>
                  <li>Build and manage the organization's social media profile and presence.</li>
                  <li>Promote additional projects to support new product launches.</li>
                  <li>Build long-term relationships with media influencers.</li>
                  <li>Appropriately manage the organization’s media budget.</li>
                  <li>Brand Management & Event Management</li>
                  <li>Brand Ambassador Management.</li>
                  <li>360 Degree Marketing Strategy Making (TTL).</li>
                  <li>Agency Coordination / Vendor Management.</li>
                  <li>Creative driving for Advertising Campaigns.</li>
                  <li>Driving Photo Shoots.</li>
                  <li>Content / Script writing for news release both in English & odia & content writing for digital marketing platforms.</li>
                  <li>Brand Research & Competitive Analysis.</li>
                </ul>
                <h6>QUALIFICATION :</h6>
                <ul class="list-dot mg-bt-15">
                  <li>Basic academic Qualification Any Graduate, MBA, PGDM, PG in Mass Communication Or Any Equivalent Courses In Media & Marketing.</li>
                  <li>Candidates with minimum 5 Years’ Experience in media marketing.</li>
                  <li>Proficient Microsoft Office, particularly Excel.</li>
