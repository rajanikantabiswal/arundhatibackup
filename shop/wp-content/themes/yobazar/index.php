...
if( is_search() ){
	yobazar_breadcrumbs_title(true, true, esc_html__( 'Search Results for: ', 'yobazar' ) . get_search_query());
}
?>
			...
			<?php	
				if( have_posts() ):
					...
					echo '<div class="alert alert-error">';
						echo '<h3>'.esc_html__('Sorry. There are no posts to display!', 'yobazar').'</h3>';
						echo '<p>'.esc_html__('Try researching for something else.', 'yobazar').'</p>';
					echo '</div>';
