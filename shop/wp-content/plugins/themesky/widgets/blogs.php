...
if( !class_exists('TS_Blogs_Widget') ){
	class TS_Blogs_Widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			$show_comment 		= function_exists('yobazar_get_post_comment_count') ? $show_comment : 0;
			...
			if( $posts->have_posts() ):
				...
				$blog_thumb_size = 'yobazar_blog_thumb';
						...
						<?php endif; ?>
							<li class="<?php echo $post_format ?>">
								...
								<div class="entry-content">								
									...
									<?php if( $show_excerpt && function_exists('yobazar_the_excerpt_max_words') ): ?>
										<div class="excerpt">
											<?php yobazar_the_excerpt_max_words($excerpt_words, $post); ?>
										</div>
									<?php endif; ?>
