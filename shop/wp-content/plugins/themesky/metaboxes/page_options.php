<?php
$options = array();
$default_sidebars = function_exists('yobazar_get_list_sidebars')? yobazar_get_list_sidebars(): array();
...
$footer_blocks = function_exists('yobazar_get_footer_block_options')? yobazar_get_footer_block_options(): array();
