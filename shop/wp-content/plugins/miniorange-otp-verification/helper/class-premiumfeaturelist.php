		...
		private function __construct() {
			$this->premium_addon = array(
				...
				'selected_country_addon'        => array(
					...
					'description' => array(
						mo_( 'Enable OTP Verification for selected countries' ),
						mo_( 'Restrict OTP Verification for selected countries' ),
					...
					'support_msg' => 'Hi I am interested in the Country Restriction Addon, could you please tell me more about this addon?',
					'plan_name'   => 'Enterprise and WooCommerce Plan',
