				...
				<div class="bg-white mt-mo-6 rounded-md items-center w-full overflow-x-auto">
					<table id="mo_report_table" class="mo-table mo-reporting-table w-full min-w-[800px]">
						<tr class="mo_report_table_heading">
							<th class="px-4 py-2 text-center" style="width: 12%;">Email/Phone</th>
							<th class="px-4 py-2 text-center" style="width: 20%;">Form Name</th>
							<th class="px-4 py-2 text-center" style="width: 15%;">Message Type</th>
							<th class="px-4 py-2 text-center" style="width: 10%;">Status</th>
							<th class="px-4 py-2 text-center" style="width: 10%;">IP Address</th>
							<th class="px-4 py-2 text-center" style="width: 13%;">Time</th>
						</tr>
					</table>
				</div>
			</div>      
