...
if ( ! class_exists( 'mob_enq_btn_style_library_Styles' ) ) :
/**
 ...
 */
class mob_enq_btn_style_library_Styles {

	/**
	 * The one instance of mob_enq_btn_style_library_Styles.
	 *
	 * @since 1.0.0.
	 *
	...
	/**
	 * Instantiate or return the one mob_enq_btn_style_library_Styles instance.
	 *
	 * @since  1.0.0.
	 *
	 * @return mob_enq_btn_style_library_Styles
	 */
	...
	private function parse_declarations( $declarations, $tab = '' ) {
		 ...
		 * routines are implemented when the developer calls `mob_enq_btn_style_library_Styles()->add`. Because every property value has
...
if ( ! function_exists( 'mob_enq_btn_style_library_Styles' ) ) :
/**
 * Return the one mob_enq_btn_style_library_Styles object.
 *
 * @since  1.0.0.
 *
 * @return mob_enq_btn_style_library_Styles	The mob_enq_btn_style_library_Styles object.
 */
function mob_enq_btn_style_library_Styles() {
	return mob_enq_btn_style_library_Styles::instance();
}
endif;

add_action( 'init', 'mob_enq_btn_style_library_Styles', 1 );
?>