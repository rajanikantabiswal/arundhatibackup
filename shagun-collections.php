...
<head>
    ...
    <title>Shagun Collections - Arundhati Jewellers</title>
    ...
    <?php include 'header.php';?>
                        ...
                        <div class="container z-index-common">
                            <div class="breadcumb-content">
                                <h1 class="breadcumb-title">Shagun <span class="inner-text">Collections</span></h1>
                                    <div class="breadcumb-menu-wrap">
                                        <div class="row">
                                        <div class="col-md-8">
                                        <ul class="breadcumb-menu">
                                            <li><a href="index.php">Home</a></li>
                                            <li>Collections <span class="inner-text"></span></li>
                                        </ul>
                                        </div>
                        ...
                        <section class="overflow-hidden space-top space-extra-bottom bg-gradient-2" style="margin-top:-100px;">
                            ...
                            <div class="container">
                                <div class="row gx-25">
                                    Coming soon with our latest collections... Stay Updated!
                                </div>   
                            </div>
                        </section>
